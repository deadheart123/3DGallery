...
public class SUPERCharacterAIO : MonoBehaviour{
    ...
    [Range(1.0f,5000.0f)]public float walkingSpeed = 140, sprintingSpeed = 260, crouchingSpeed = 45;
    [Range(1.0f,2500.0f)] public float decelerationSpeed=1500;
    #if ENABLE_INPUT_SYSTEM
...
public class SuperFPEditor : Editor{
    ...
    public override void OnInspectorGUI(){
        ...
        if(movementSettingFoldout){
            ...
            EditorGUILayout.Space();
            t.walkingSpeed = EditorGUILayout.Slider(new GUIContent("Walking Speed", "How quickly can the player move while walking?"),t.walkingSpeed,1,2500);
            ...
            #endif
            t.sprintingSpeed = EditorGUILayout.Slider(new GUIContent("Sprinting Speed", "How quickly can the player move while sprinting?"),t.sprintingSpeed,t.walkingSpeed+1,4000);
            t.decelerationSpeed = EditorGUILayout.Slider(new GUIContent("Deceleration Factor", "Behaves somewhat like a braking force"),t.decelerationSpeed,1,2500);
            EditorGUILayout.EndVertical();
            ...
            t.enableMovementControl = EditorGUILayout.ToggleLeft(new GUIContent("Enable Movement","Should the player have control over the character's movement?"),t.enableMovementControl);
            t.walkingSpeed = EditorGUILayout.Slider(new GUIContent("Walking Speed", "How quickly can the player move while walking?"),t.walkingSpeed,1,5000);
            t.sprintingSpeed = EditorGUILayout.Slider(new GUIContent("Sprinting Speed", "How quickly can the player move while sprinting?"),t.sprintingSpeed,t.walkingSpeed+1,7500);
        }
        EditorGUILayout.Space();
